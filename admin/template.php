  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="bg-primary brand-link">
        <a href="">
          <img src="<?= base_url('assets/images/logo/307e63eb8c9baa8788d5d5c5896012bd.png') ?>" alt="Nounna Saritie" class="brand-image img-circle elevation-3 bg-white" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        echo "<div class='user-panel mt-3 pb-3 mb-3 d-flex'>
              ...
              <div class='info text-center'>
                <a class='d-block'>$log[nama_lengkap]</a>
